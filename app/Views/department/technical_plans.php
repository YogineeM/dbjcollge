								...
								<div class="description-text">
									<div class="row">
										...
										<div class="col-sm-12" style="text-align: justify;"
											id="teaching_plan">
											<!-- 											<p class="text-black" -->
<!-- 											style="line-height: 30px; font-family: 'Roboto', sans-serif; -->
<!-- 											font-size: 16px"> -->
									...
									<div class="col-sm-12">
										<div class="categories-item">
											...
											<ul class="list-unstyled">
												...
												<li><a
													href="<?php echo base_url();?>/naac/vision"><i
														class="fa fa-angle-right"></i>Vision</a></li>
												<li><a
													href="<?php echo base_url();?>/naac/objective"><i
														class="fa fa-angle-right"></i>Objective</a></li>
												<li><a
													href="<?php echo base_url();?>/naac/composition"><i
														class="fa fa-angle-right"></i>Composition</a></li>
												<li><a href="<?php echo base_url();?>/naac/operational_features"><i
			...
			<div class="col-sm-12">
										<div class="categories-item">
											...
											<ul class="list-unstyled">
												<li><a href="<?php echo base_url();?>/naac/introduction"><i
														class="fa fa-angle-right"></i>Arts</a></li>
												<li><a
													href="<?php echo base_url();?>/naac/vision"><i
														class="fa fa-angle-right"></i>Commerce</a></li>
												<li><a
													href="<?php echo base_url();?>/naac/objective"><i
														class="fa fa-angle-right"></i>Accountancy</a></li>
												<li><a
													href="<?php echo base_url();?>/naac/composition"><i
														class="fa fa-angle-right"></i>Science</a></li>
												<li><a href="<?php echo base_url();?>/naac/operational_features"><i
														class="fa fa-angle-right"></i>Management</a></li>
...
// 			var curriculumHeads=[];
			...
			function getIntroduction() {
				...
				var url="http://localhost/ies/public/dbj/getTeachingPlans/"+teachingId;
...
// 							for(let head of heads)
	for(department of departments){
		...
		teaching_plan =`<p class="text-black"
				style="line-height: 30px; font-family: 'Roboto', sans-serif; font-size: 16px">
${department.teaching_plan}
				</p>`;
		 
			$('#teaching_plan').append(teaching_plan);
			}
