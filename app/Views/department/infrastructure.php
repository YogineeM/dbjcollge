												...
												<div class="col-sm-12">
													<div class="categories-item">
														...
														<ul class="list-unstyled">
															...
															<li><a
																href="<?php echo base_url();?>/naac/best_practices"><i
															...
															<div class="col-sm-12">
																<ul class="list-unstyled">
																	...
																	<li><a href="#" class="twitter"><i
																			class="fa fa-twitter"></i>Follow us</a></li>
																	<li><a href="#" class="facebook"><i
																			class="fa fa-facebook"></i>like us</a></li>
...
// 			var curriculumHeads=[];
			...
			function getIntroduction() {
				...
				var url="http://localhost/ies/public/dbj/getInfra/"+infrastructreId;
				...
				$.get(url,
					function(data, status) {
						try {
							...
							infrastructre =`
								<p class="text-black"style="line-height: 30px; font-family: 'Roboto', sans-serif; font-size: 16px">
										${departments.infrastructre}
											</p>`;
		 
											$('#infrastructre').append(infrastructre);
