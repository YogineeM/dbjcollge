...
<!-- Mirrored from ecologytheme.com/theme/eduread/index-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Mar 2021 10:52:42 GMT -->
<head>
    <meta charset="utf-8">
...
<header id="header">
		...
		<nav class="navbar edu-navbar">
			<div class="container">
				<div class="navbar-header">
					...
					<a href="index-2.html" class="navbar-brand  data-scroll"><img src="<?php echo base_url(); ?>/resources/images/logo.png" alt=""><span>D.B.J. COLLEGE</span></a>
				</div>

				<div class="collapse navbar-collapse edu-nav main-menu" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav pull-right">
						<li class="active"><a data-scroll
							href="<?php echo base_url()?>/home/index">Home</a></li>
						<li><a data-scroll="" href="index-2.html">About</a> <!-- dropdwon start -->
							<ul class="dropdown list-unstyled">
								<li><a href="<?php echo base_url()?>/about/nesociety">NE Society</a></li>
								<li><a href="<?php echo base_url()?>/about/governing_council">Goverment
										Concil</a></li>
								<li><a href="<?php echo base_url()?>/about/message/chairman">Chairman's
										Message</a></li>
								<li><a href="<?php echo base_url()?>/about/message/pricipal">Pricipal
										Message</a></li>
								<li><a href="<?php echo base_url()?>/about/perspective">Perspective
										Plan</a></li>
								<li class="dropdown-list-box-02"><a href="#">Committees<i
										class="fa fa-angle-right menu-icon"></i></a>
									<ul class="dropdown-list_2 list-unstyled">
										<li><a href="<?php echo base_url()?>/college/committees/development">College Development</a></li>
										<li><a href="<?php echo base_url()?>/college/committees/special_cell">Special Cell</a></li>
										
									</ul></li>
							</ul> <!-- dropdown end --></li>
						<li><a data-scroll="" href="courses-01.html">Departments</a> <!-- dropdwon start -->
							<ul class="dropdown list-unstyled">
								...
								<li><a href="course-details-left-sidebar.html">Course Details
										Sidebar</a></li>
							</ul> <!-- dropdown end --></li>

						<li><a data-scroll href="#">Resources</a>
						...
						<li><a data-scroll href="event-list.html">IQAC</a> <!-- dropdwon start -->
							<ul class="dropdown list-unstyled">
								<li><a href="<?php echo base_url();?>/naac/introduction">Introduction</a></li>
								<li><a href="<?php echo base_url();?>/naac/vision">Vision</a></li>
								<li><a href="<?php echo base_url();?>/naac/objective">Objective</a></li>
								<li><a href="<?php echo base_url();?>/naac/composition">Compostion</a></li>
								<li><a href="<?php echo base_url();?>/naac/operational_features">Operational Features</a></li>								
								<li><a href="<?php echo base_url();?>/naac/aqar">AQAR</a></li>
								<li><a href="<?php echo base_url();?>/naac/members">Members</a></li>								
								<li><a href="<?php echo base_url();?>/naac/iqac_mom">IQAC MOM</a></li>
								<li><a href="<?php echo base_url();?>/naac/pso">PSO</a></li>
								<li><a href="<?php echo base_url();?>/naac/best_practices">Best Practices</a></li>
								<li><a href="<?php echo base_url();?>/naac/sop">SOP</a></li>
							</ul> <!-- dropdown end --></li>
						<li><a data-scroll href="teachers-01.html">Media</a> <!-- dropdwon start -->
							<ul class="dropdown list-unstyled">
						...
						<li><a data-scroll href="blog.html">Contact</a> <!-- dropdwon start -->
							<ul class="dropdown list-unstyled">
								<li><a href="<?php echo base_url()?>/college/contact">Contact</a></li>
								<li><a href="<?php echo base_url()?>/college/alumni">Alumni</a></li>								
								<li><a href="<?php echo base_url()?>/college/feedback">Feedback</a></li>
							</ul> <!-- dropdown end --></li>
    ...
    <div class="rev_slider_wrapper">
        <div id="rev_slider_1" class="rev_slider" style="display:none">
            ...
            <!-- BEGIN SLIDES LIST -->
            <ul>
				<li data-transition="boxfade" data-title="Slide Title" data-param1="Additional Text" data-thumb="<?php echo base_url(); ?>/resources/images/index-02/slide-03.jpg">
                	<div class="slider-overlay"></div>
					<!-- SLIDE'S MAIN BACKGROUND IMAGE -->
					<img src="<?php echo base_url(); ?>/resources/images/index-02/slide-03.jpg" alt="Sky" class="rev-slidebg">
                ...
                <li data-transition="random" data-title="Slide Title" data-param1="Additional Text" data-thumb="<?php echo base_url(); ?>/resources/images/index-02/slide-04.jpg">
                	<div class="slider-overlay"></div>
					<!-- SLIDE'S MAIN BACKGROUND IMAGE -->
					<img src="<?php echo base_url(); ?>/resources/images/index-02/slide-04.jpg" alt="Sky" class="rev-slidebg">
					<!-- BEGIN BASIC TEXT LAYER -->
					<!-- LAYER NR.1 -->
					<div class="tp-caption sfr font-extra-bold tp-resizeme letter-space-4 header-1 title-line-1" 
						data-x="left" data-hoffset="0" 
		...
		<div class="row">
			<div class="col-sm-4 wel-ful-box-2">
				<div class="wel-text-box">
					<div class="wel-icon">
						<img src="<?php echo base_url(); ?>/resources/images/index-02/welcome-01.png" alt="">
					</div>
					<div class="wel-text">
			...
			<div class="col-sm-4 wel-ful-box-2">
				<div class="wel-text-box">
					<div class="wel-icon">
						<img src="<?php echo base_url(); ?>/resources/images/index-02/welcome-02.png" alt="">
					</div>
					<div class="wel-text">
			...
			<div class="col-sm-4  wel-ful-box-2">
				<div class="wel-text-box">
					<div class="wel-icon">
						<img src="<?php echo base_url(); ?>/resources/images/index-02/welcome-03.png" alt="">
					</div>
					<div class="wel-text">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-7 form-content">
					...
					<p>Lorem ipsum dolor sit amet mollis felis dapibus arcu donec viverra. Pede phasellus eget. Etiam maecenas vel vici quis dictum rutrum nec nisi et. Ac penatibus aenean laoreet. Pede enim nunc ultricies quis rhoncus penatibus tincidunt integer felis quam neque ridiculus. Dapibus sit vel amet libero quisque Ante vel quis ultricies elit.</p>	
				</div>
			</div>
		</div>
	</div>
...
<section class="Courses-area-02">
	<div class="container">	
		...
		<div class="row courses-r-margin-bottom">
			<div class="col-sm-6 col-md-3 single-courses-box">
			    <div class="single-courses">
					<figure>
						<a href="#">
							<div class="figure-img">
								<img src="<?php echo base_url(); ?>/resources/images/index-02/courses-demo2-01.jpg" alt="" class="img-responsive">
							</div>
						</a>
						<figcaption>
							<ul class="list-unstyled">
								<li class="courses-free">free</li>
								<li class="rating">
					...
					<div class="courses-content-box">
						<div class="courses-content">
							<h3><a href="#">WordPress: Creating Custom Plugins</a></h3>
							<p class="data-comment"> July 21, 2019 / No Comment</p>
						</div>						
					</div>
			...
			<div class="col-sm-6 col-md-3 single-courses-box">
			    <div class="single-courses">
					<figure>
						<a href="#">
							<div class="figure-img">
								<img src="<?php echo base_url(); ?>/resources/images/index-02/courses-demo2-02.jpg" alt="" class="img-responsive">
						...
						<figcaption>
							<ul class="list-unstyled">
								<li class="courses-free">$50.00</li>
								<li class="rating">
									<span><i class="fa fa-star"></i></span>
									<span><i class="fa fa-star"></i></span>
									<span><i class="fa fa-star"></i></span>
					...
					<div class="courses-content-box">
						<div class="courses-content">
							<h3><a href="#">Learning jQuery Mobi- le for Beginners</a></h3>
							<p class="data-comment"> July 21, 2019 / 1 No Comment</p>
						</div>						
					</div>
				</div><!-- Ends: .single courses -->
			</div><!-- Ends: . -->
			...
			<div class="col-sm-6 col-md-3  single-courses-box">
			   <div class="single-courses">
					<figure>
						<a href="#">
							<div class="figure-img">
								<img src="<?php echo base_url(); ?>/resources/images/index-02/courses-demo2-03.jpg" alt="" class="img-responsive">
							</div>
						</a>
						<figcaption>
							<ul class="list-unstyled">
					...
					<div class="courses-content-box">
						<div class="courses-content">
							<h3><a href="#">The Ultimate Ethical Hacking Boot Camp</a></h3>
							<p class="data-comment"> July 21, 2019 / No Comment</p>
						</div>						
					</div>
				</div><!-- Ends: .single courses -->
			...
			<div class="col-sm-6 col-md-3 single-courses-box">
			    <div class="single-courses">
					<figure>
						<a href="#">
							<div class="figure-img">
								<img src="<?php echo base_url(); ?>/resources/images/index-02/courses-demo2-04.jpg" alt="" class="img-responsive">
							</div>
						</a>
						<figcaption>
							<ul class="list-unstyled">
					...
					<div class="courses-content-box">
						<div class="courses-content">
							<h3><a href="#">Microsoft Excel 2016 Advan- ced Training</a></h3>
							<p class="data-comment"> July 21, 2019 / No Comment</p>
						</div>						
					</div>
				</div><!-- Ends: .single courses -->
			...
			<div class="col-sm-6 col-md-3 single-courses-box">
				<div class="single-courses">
					<figure>
						<a href="#">
							<div class="figure-img">
								<img src="<?php echo base_url(); ?>/resources/images/index-02/courses-demo2-05.jpg" alt="" class="img-responsive">
							</div>
						</a>
						<figcaption>
							<ul class="list-unstyled">
					...
					<div class="courses-content-box">
						<div class="courses-content">
							<h3><a href="#">Photography for Beg- inners Masterclass</a></h3>
							<p class="data-comment"> July 21, 2019 / No Comment</p>
						</div>						
					</div>
				</div><!-- Ends: .single courses -->
			...
			<div class="col-sm-6 col-md-3 single-courses-box">
			    <div class="single-courses">
					<figure>
						<a href="#">
							<div class="figure-img">
								<img src="<?php echo base_url(); ?>/resources/images/index-02/courses-demo2-06.jpg" alt="" class="img-responsive">
							</div>
						</a>
						<figcaption>
							<ul class="list-unstyled">
					...
					<div class="courses-content-box">
						<div class="courses-content">
							<h3><a href="#">Android App Develop- ment Essentials</a></h3>
							<p class="data-comment"> July 21, 2019 / No Comment</p>
						</div>						
					</div>
				</div><!-- Ends: .single courses -->
			...
			<div class="col-sm-6 col-md-3 single-courses-box">
			    <div class="single-courses">
					<figure>
						<a href="#">
							<div class="figure-img">
								<img src="<?php echo base_url(); ?>/resources/images/index-02/courses-demo2-07.jpg" alt="" class="img-responsive">
								<div class="sale-banner">
									<span>sale</span>
								</div>	
							</div>
						...
						<figcaption>
							<ul class="list-unstyled">
								<li class="courses-free">$25.00 <span>35.00</span></li>
								<li class="rating">
									<span><i class="fa fa-star"></i></span>
									<span><i class="fa fa-star"></i></span>
									<span><i class="fa fa-star"></i></span>
			...
			<div class="col-sm-6 col-md-3 single-courses-box">
			    <div class="single-courses">
					<figure>
						<a href="#">
							<div class="figure-img">
								<img src="<?php echo base_url(); ?>/resources/images/index-02/courses-demo2-08.jpg" alt="" class="img-responsive">
							</div>
						</a>
						<figcaption>
							<ul class="list-unstyled">
		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				<div class="info-content-box">
					...
					<p>Lorem ipsum dolor sit amet mollis felis dapibus arcu donec viverra Pede phasell us eget Etiam maecenas vel vici quis dictum rutrum nec nisi  Ac penatibus.</p>	
					<div class="info-btn">
...
<section class="events-area">
	<div class="container">
		...
		<div class="row event-body-content">
			<div class="col-sm-6 event-single">
				<div class="events-single-box">
					<div class="row">
						<div class="col-sm-12">
							<img src="<?php echo base_url(); ?>/resources/images/index-02/events-01.jpg" alt="" class="img-responsive">
						</div>
						...
						<div class="col-sm-12">
							<div class="event-info">
								...
								<p>Lorem ipsum dolor sit amet mollis felis dapibus arcur donec viverra phasellus eget. Etiam maecenas vel vici quis.</p>
			...
			<div class="col-sm-6 event-single">
				<div class="events-single-box">
					<div class="row">
						<div class="col-sm-12">
							<img src="<?php echo base_url(); ?>/resources/images/index-02/events-02.jpg" alt="" class="img-responsive">
						</div>
						
						<div class="col-sm-12">
							<div class="event-info">
								<h3>Discover something great to do on campus.</h3>
								<p class="events-time">
									<span>
										<i class="fa fa-calendar event-icon"></i>
										1st January
...
<!-- Student Parent Say Area section -->
<section class="stu-parent-say-area">
	<div class="overlay-bg">
		<div class="container">
			<div class="row">
				<div class="col-sm-12 section-header-box">
			...
			<div class="row">
				<div class="screen-content-box  wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".5s">
					<div class="testimonial-wrapper owl-carousel" id="parent-say-02">		
						<div>
							<div class="single--item">
								<div class="content-box">
									<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonuy my nibh euismod tincidunt ut laoreet dolore magna aliquam erat.</p>
									<ul class="list-unstyled rating-box">
								...
								<div class="<?php echo base_url(); ?>/resources/images-box">
									<ul class="list-unstyled">
										<li><img src="<?php echo base_url(); ?>/resources/images/index/teachar-s-01.jpg" alt=""></li>
										<li>
						...
						<div>
							<div class="single--item">
								...
								<div class="<?php echo base_url(); ?>/resources/images-box">
									<ul class="list-unstyled">
										<li><img src="<?php echo base_url(); ?>/resources/images/index/teachar-s-03.jpg" alt=""></li>
										<li>
											<h3>taylor swift </h3>
											<span>Jerry, Parents</span>
										</li>
									</ul>
								</div>
							</div>
						...
						<div>
							<div class="single--item">
								...
								<div class="<?php echo base_url(); ?>/resources/images-box">
									<ul class="list-unstyled">
										<li><img src="<?php echo base_url(); ?>/resources/images/index/teachar-s-02.jpg" alt=""></li>
										<li>
											<h3>Jhonthan Smith</h3>
											<span>Alexis, Parents</span>
										</li>
						...
						<div>
							<div class="single--item">
								...
								<div class="<?php echo base_url(); ?>/resources/images-box">
									<ul class="list-unstyled">
										<li><img src="<?php echo base_url(); ?>/resources/images/index/teachar-s-04.jpg" alt=""></li>
										<li>
											<h3>oscar charls</h3>
											<span>Perry, Parents</span>
										</li>
									</ul>
								</div>
							</div>
						...
						<div>
							<div class="single--item">
								...
								<div class="<?php echo base_url(); ?>/resources/images-box">
									<ul class="list-unstyled">
										<li><img src="<?php echo base_url(); ?>/resources/images/index/teachar-s-05.jpg" alt=""></li>
										<li>
											<h3>Jhonthan Smith</h3>
											<span>Alexis, Parents</span>
										</li>
...
<!-- ./ End Student Parent Say section -->
...
<section class="teachers-area">
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-6 col-md-3 team-single-info-02">
				<div class="teacher-body">
					<img src="<?php echo base_url(); ?>/resources/images/index-02/teachar-01.jpg" alt="" class="img-responsive">
			...
			<div class="col-sm-6 col-md-3 team-single-info-02">
				<div class="teacher-body">
					<img src="<?php echo base_url(); ?>/resources/images/index-02/teachar-02.jpg" alt="" class="img-responsive">
					<div class="teachars-info">
						<h3>Michael Smith</h3>
			...
			<div class="col-sm-6 col-md-3 team-single-info-02">
				<div class="teacher-body">
					<img src="<?php echo base_url(); ?>/resources/images/index-02/teachar-03.jpg" alt="" class="img-responsive">
					<div class="teachars-info">
						<h3>Katie Hale</h3>
			...
			<div class="col-sm-6 col-md-3 team-single-info-02">
				<div class="teacher-body">
					<img src="<?php echo base_url(); ?>/resources/images/index-02/teachar-04.jpg" alt="" class="img-responsive">
					<div class="teachars-info">
						<h3>Willian Kane</h3>
		...
		<div class="row">
			<div class="col-sm-4 latest-news-single">
				<div class="blog-single-box">
					<div class="img-box">
						<img src="<?php echo base_url(); ?>/resources/images/index-02/news-01.jpg" alt="" class="img-responsive">
					</div>
					<div class="blog-content">
						...
						<div class="content-bottom">
							...
							<ul class="list-unstyled">
								<li class="first-item"><a href="#">Read More<i class="fa fa-long-arrow-right blog-btn-icon"></i></a></li>
			...
			<div class="col-sm-4 latest-news-single">
				<div class="blog-single-box">
					<div class="img-box">
						<img src="<?php echo base_url(); ?>/resources/images/index-02/news-02.jpg" alt="" class="img-responsive">
					</div>
					<div class="blog-content">
						<h3><a href="#">The future of Web Design</a></h3>
						<p class="blog-time">
			...
			<div class="col-sm-4 latest-news-single">
				<div class="blog-single-box">
					<div class="img-box">
						<img src="<?php echo base_url(); ?>/resources/images/index-02/news-03.jpg" alt="" class="img-responsive">
					</div>
					<div class="blog-content">
						<h3><a href="#">The future of Web Design</a></h3>
						<p class="blog-time">
		...
		<div class="row inspiration-full-box">
			...
			<div class="col-md-3">
				<div class="instraction-btn">
					<a href="#" >get strated now</a>
				</div>
			</div>
		</div>
	</div>
</section><!-- ./ .instraction-area -->
...
<!-- Mirrored from ecologytheme.com/theme/eduread/index-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Mar 2021 10:53:37 GMT -->
</html>
