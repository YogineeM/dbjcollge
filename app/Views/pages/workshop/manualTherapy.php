<div class="elh-page-header elh-img-bg elh-bg-9"
	...
	<div class="elh-overlay">
		<div class="container text-center">
			<h3 class="elh-page-title">Manual Therapy</h3>
			<ol class="breadcrumb">
...
<!-- 				<h3>Credential:</h3> -->
				<p style="text-align: justify; font-size: 15px">
<!-- 				Kinesio University Seminars are accepted by many professional -->
	...
	function getCourse(){
		...
		$.get("http://localhost/moveheal-crm/public/learning/courses/all", function(data, status){
				...
				for(course of courses){
					...
					if(course.CourseHead=="2"){
					$('#courses').append(`
							
				<div class="col-lg-4 col-md-6" style="height:600%">
					<article class="elh-post style-3">
						<a class="elh-post-thumb" href="../training/upcoming/corporate"> <img
							class="img-fluid"
							src="${imageUrl}"
							alt="...">
						</a>
