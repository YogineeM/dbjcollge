								...
								<div class="description-text">
									<div class="row">
										...
										<div class="col-sm-11">
											...
											<h4>Programme Specific Outcome (PSO)</h4>
											<hr />
											...
											<ul class="list-unstyled list-services"
												style="padding-left: 20px; font-size: 16px; font-family: 'Roboto', sans-serif; line-height: 40px">
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Develop
													entrepreneurial and managerial skills</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Develops
													analytical skills</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Application
													of theoretical knowledge practically</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Analysis
													and interpretation of financial statements</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Market
													Analysis</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Understanding
													business environment</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Developing
													knowledge of business laws</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Decision
													making skills</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Understanding
													role of Banking &amp; Insurance sector</li>
											</ul>
											<hr />
											...
											<ul class="list-unstyled list-services"
												...
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Sensitize
													with social issues</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Develop
													basic skills for personal and professional life</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Foundation
													to built career</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Understand
													human values</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Understand
													and develop language proficiency</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Understand
													literature</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Developing
													writing and communication skills</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Conceptual
													understanding</li>
											...
											<ul class="list-unstyled list-services"
												style="padding-left: 20px; font-size: 16px; font-family: 'Roboto', sans-serif; line-height: 40px">
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Awareness
													of environmental issues</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Developing
													scientific knowledge</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Developing
													problem solving skills</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Handling
													laboratory instruments</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Scientific
													knowledge</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Conceptual
													understanding</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Develop
													new applications, software, formulae</li>
