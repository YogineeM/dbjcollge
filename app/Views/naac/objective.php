									...
									<div class="row">
										...
										<div class="col-sm-12" style="text-align: justify;">
											...
											<p class="text-black"
												...
												The primary aim of IQAC is To develop a system for
												conscious, consistent and catalytic action to improve the
												academic and administrative performance of the institution.</p>



											<ul class="list-unstyled list-services"
												style="padding-left: 20px; font-size: 16px; font-family: 'Roboto', sans-serif; line-height: 35px">
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;
													...
													performance of the institution.</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;To
													promote measures for institutional functioning towards
													quality enhancement through internalization of quality
													culture and institutionalization of best practices.</li>
											</ul>
