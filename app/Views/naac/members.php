										...
										<div class="col-sm-11">
											<div class="description-text-right">
												<ul class="list-unstyled list-services"
													...
													<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Principal
														Dr. S. S. Bal</li>
													<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Dr.
														M.S. Chanda</li>
													<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Dr.
														Smt. S. J. Sapre- Bharmal IQAC Coordinator</li>
													<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Mr.
														R. V. Redij</li>
													<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Dr.
														S.J. Mehendale</li>
													<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Dr.
													...
													<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Mr.
														S. R. Bhadule</li>
													<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Mrs.
														R. P. Khavanekar</li>
													<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Mr.
														N. A. Pedamkar- I/C Registrar</li>
													<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Ms
														Akshata Bapat- Students' Representative</li>
													<li><i class="fa fa-chevron-circle-right color-gray-light"></i>&nbsp;Mr.
														Aryan Alvi- Students' Representative</li>
												</ul>
