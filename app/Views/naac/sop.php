								...
								<div class="description-text">
									<div class="row">
										...
										<div class="col-sm-11">
											...
											<h4 class="text-black"
												style="line-height: 25px; font-size: 15px; font-family: 'Roboto', sans-serif; font-size: 16px">


												SOP for Curriculum Planning and Delivery</h4>

											<p class="text-black"
												style="line-height: 25px; font-size: 15px; font-family: 'Roboto', sans-serif; font-size: 16px">
												All the Staff members are required to follow the Standard
												Operating Procedure mentioned in the following:</p>
											...
											<ul class="list-unstyled list-services"
												...
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>
													The teachers should download and confirm the syllabus for
													their respective course from the affiliating University
													Website.</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>The
													syllabus should be published on the institution website</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>The
													teachers should inform the students about the syllabus for
													their chosen courses.</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>The
													Heads of the Departments should ensure that the faculty has
													prepared Teaching Plans for each of their papers.</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>A
													copy of the teaching Plans should be kept in the
													departmental records.</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>After
													completion of each topic, the Head of the Department should
													sign the Teaching Plan.</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>The
													teachers should read out the syllabus to the students in
													the class.</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>The
													library should be informed if there are any changes in the
													syllabus.</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>The
													library should buy the required copies of the text
													books/reference books/workbooks</li>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>The
													IQAC should monitor the procedure.</li>
											</ul>
