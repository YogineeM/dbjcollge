		...
		<div class="row">
			<div class="col-sm-5 contact-info">
				<div class="col-sm-12 contact-title">
					<h2>Contact Info</h2>		
					<p class="content-sub_p">Welcome to our D . B . J College, Chiplun.</p>
				</div>
					...
					<div class="row">
						<div class="col-sm-12 col-md-12 single-address-box">
                            <div class="single-address">
                                ...
                                <h4>Phone</h4>
                                <p class="text-black">+91 (02355)-252088, 256588 </p>
                            </div>
                        </div>  
                        <div class="col-sm-12 col-md-12  single-address-box">
                            <div class="single-address">
                                ...
                                <h4>Email</h4>
                                <p class="text-black">dbjcollege@rediffmail.com</p>
                            </div>
                        </div> 
                        <div class="col-sm-12 col-md-12 single-address-box">
                            <div class="single-address">
                                ...
                                <h4>Location:</h4>
                                <p class="text-black">Mumbai -Goa Highway NH 66, S.K. Patil Nagar, </p><p class="text-black" style="margin-left: 45px"> Chiplun, Maharashtra 415605</p>
                            </div>
	                    </div> 
			...
			<div class="col-sm-6  col-sm-offset-1 contact-form">
				<div class="row">
					<div class="col-sm-12 contact-title-btm">
						...
						<p class="content-sub_p text-black">Welcome to our Website. We are glad to have you around.</p>
					</div>
				</div>
