								...
								<div class="description-text">
									<div class="row">
										...
										<div class="col-sm-12" style="text-align: justify;"
											...
											<ul class="list-unstyled list-services" style="line-height: 30px; font-family: 'Roboto', sans-serif; font-size: 18px"
												>
												<li><i class="fa fa-chevron-circle-right color-gray-light"></i>	Prin. Dr. S. S. Bal</li>
				<li><i class="fa fa-chevron-circle-right color-gray-light"> </i>Mr. R. M. Suryavanshi</li>
				<li><i class="fa fa-chevron-circle-right color-gray-light"></i>Dr. S. S. Mane	</li>
				<li><i class="fa fa-chevron-circle-right color-gray-light"></i>Mr. A. P. Kalutaki</li>
