									...
									<div class="row">
										...
										<div class="col-sm-11">
											<div class="description-text-right">
												<ul class="list-unstyled list-services" style="padding-left: 40px; font-size: 16px;font-family: 'Roboto', sans-serif;line-height: 40px">
													<li><i class="fa fa-chevron-circle-right color-gray-light"></i>
														<a href="../resources/pdf/libmore1.pdf" target="_blank">INFORMATION
															SEEKING BEHAVIOR OF UNDER-GRADUATE STUDENTS IN RATNAGIRI
															DISTRICT COLLEGES, AFFILIATED TO UNIVERSITY OF MUMBAI,
															MAHARASHTRA</a></li>
													<li><i class="fa fa-chevron-circle-right color-gray-light"></i>
														<a href="../resources/pdf/libmore2.pdf" target="_blank">A
															Study of Disaster Management Plans Prepared by College
															Libraries in Ratnagiri District</a></li>
												</ul>
											</div>
										</div>
									</div>
