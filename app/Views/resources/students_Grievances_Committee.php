	...
	<div class="post_1_area blog-area">
		<div class="container">
			<div class="row">
						...
						<div class="col-sm-12">
							<div class="description-content">
								<div class="description-heading">
									...
									<h3>Students' Grievances Committee</h3>
								</div>
				...
				<li><i class="fa fa-chevron-circle-right color-gray-light"> </i> Dr. B. S. Kamble</li>
				<li><i class="fa fa-chevron-circle-right color-gray-light"></i> Dr. S. S. Waghmode	</li>
